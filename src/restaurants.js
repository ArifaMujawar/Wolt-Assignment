    ...
    return (
      <div>
        <div className="wrapper">
          <button className="button" onClick={this.sortRestaurants}>Sort restaurants </button>
        </div>
        <div className="card">
              ...
              <Card key={idx}>
                <CardContent className="card-content">
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="textSecondary" component="h6">{restaurant.city}</Typography>
